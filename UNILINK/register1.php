<?php 
    ...
    if($uni_id_count>0){
        ...
        $sql = "INSERT INTO `users` (`username`, `email`, `job`, `university_id`, `phone`, `department`, `password`, `id_card_img`) VALUES ('$name', '$email', '$faculty_or_student', '$uni_id', '$phoneNumber', '$dept', '$password', '$new_image_name')";
