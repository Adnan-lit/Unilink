<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "UPDATE `course` SET `c_name` = '$courseName', `c_code` = '$courseCode', `creditHour` = '$creditHour', `department` = '$department', `prereq` = '$prerequisite', `c_description` = '$description' WHERE `c_id` = '$courseId'";
        $result = mysqli_query($conn, $sql);
        if($result){
...
<head>
    ...
    <title>UPDATE Course-UNILINK</title>
</head>
