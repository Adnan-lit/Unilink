...
<body>
    ...
    <section class="faq">
      <div class="container">
        ...
        <ul class="faq-list">
          ...
          <li>
            <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq1">Why Unilink? <i class="bx bx-down-arrow-alt icon-show"></i><i class="bx bx-x icon-close"></i></a>
            <div id="faq1" class="collapse" data-bs-parent=".faq-list">
              <p>
              Unilink simplifies UIUians life by offering a one-stop solution for accommodation, food, and study services. Save time, find tailored options, and enhance your student experience—all in one place!
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>UNILINK</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
