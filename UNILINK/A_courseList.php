<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO `course`(`c_name`, `c_code`, `department`, `creditHour`, `prereq`, `c_description`) VALUES ('$courseName','$courseCode', '$dept','$creditHour','$cPrerequisite','$cDescription')";
        $result = mysqli_query($conn, $sql);
        if($result){
...
<head>
    ...
    <title>Course List-Unilink</title>
