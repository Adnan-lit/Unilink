<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $sql = "UPDATE `users` SET `username`='$name',`email`='$email',`job`='$faculty_or_student',`university_id`='$uni_id',`phone`='$phoneNumber',`department`='$dept',`password`='$password',`id_card_img`='$new_image_name' WHERE userid='$updateId'";
...
<head>
    ...
    <title>Update User-UNILINK</title>
</head>
