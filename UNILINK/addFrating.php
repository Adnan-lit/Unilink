<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO `facultyReview` (`faculty_id`, `teaching_method`, `communication_skill`, `availability`, `supportive`, `take_feedback`,`marking`, `rated_by`) VALUES ('$f_id', '$teachingMethod', '$communication', '$counselling', '$supportive', '$feedback','$marking','$userId')";
        $result = mysqli_query($conn, $sql);
        if($result){
