<?php 
    ...
    if(isset($_POST['addBook'])){
      ...
      $currDate = date("Y-m-d");
        $sql = "INSERT INTO `booksdetail` (`title`, `author`, `description`, `price`, `image`, `posted_by`, `postDate`) VALUES ('$bookName', '$bookAuthor', '$bookDescription', '$bookPrice', '$upload_image', '$userId', '$currDate')";
      $result = mysqli_query($conn, $sql);
      if($result == true){
...
<head>
    ...
    <title>Book Exchange-UNILINK</title>
